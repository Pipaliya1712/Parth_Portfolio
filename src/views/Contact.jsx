...
const Contact = () => {
  ...
  return (
    <div
      ...
      className={
        darkMode
          ? "bg-gray-100 pt-24 md:h-full"
          : "bg-black pt-24 text-white md:h-full"
      }
    >
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 ">
        ...
        <div className="flex justify-between items-center md:items-stretch  flex-col md:flex-row pb-24">
          ...
          <form action="https://formspree.io/f/xzbnnvde" method="POST" >
              <div class="my-6">
                <label
                  for="name"
                  required
              ...
              <div className="flex justify-between ">
                <div className="underline">
                  <a href="mailto:parthpipaliya1112@gmail.com">
